...
namespace CosmosX.Entities.Containers
{
    ...
    {
        private readonly int moduleCapacity;
        private readonly IList<IModule> modulesByInput;
        private readonly IDictionary<int, IEnergyModule> energyModules;
        private readonly IDictionary<int, IAbsorbingModule> absorbingModules;
        ...
        public long TotalEnergyOutput 
            => this.energyModules.Values.Sum(m => m.EnergyOutput);

        public long TotalHeatAbsorbing
            => this.absorbingModules.Values.Sum(m => m.HeatAbsorbing);
