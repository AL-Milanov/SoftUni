namespace _01.RoyaleArena.Tests
{
    ...
    public class RoyaleArenaTests
    {
        ...
        [Test]
        public void GetInSwagRange_ShouldReturn_EmptyCollection()
        {
            //Arrange
            IArena RA = new RoyaleArena();
            BattleCard cd1 = new BattleCard(5, CardType.SPELL, "dragon", 8, 121);
            BattleCard cd2 = new BattleCard(6, CardType.SPELL, "raa", 7, 122);
            BattleCard cd3 = new BattleCard(7, CardType.SPELL, "maga", 6, 125.5);
            BattleCard cd4 = new BattleCard(12, CardType.SPELL, "shuba", 5, 115.6);
            BattleCard cd5 = new BattleCard(15, CardType.SPELL, "tanuki", 5, 17.8);
        ...
        [Test]
        public void FindFirstLeastSwag_ShouldThrowExeption()
        {
            //Arrange
            IArena RA = new RoyaleArena();
            BattleCard cd1 = new BattleCard(5, CardType.SPELL, "joro", 6.0, 1.0);
            ...
            //Assert
            Assert.Throws<InvalidOperationException>(() => { RA.FindFirstLeastSwag(100); });
        }
