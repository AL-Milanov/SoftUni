...
export let createFurintureTemplate = (submitHandler, invalid) => html`
<div class="container">
        ...
        <div class="row space-top">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control valid ${invalid.make ? 'is-invalid' : ' is-valid'}" id="new-make" type="text" name="make">
                </div>
