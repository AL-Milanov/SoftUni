...
export let editTemplate = (furniture, submitHandler, invalid) => html`
    ...
    <div class="row space-top">
        <div class="col-md-4">
            ...
            <div class="form-group has-success">
                ...
                <input class="form-control is-valid ${invalid.model ? 'is-invalid' : ' is-valid'}" id="new-model" type="text" name="model" value="${furniture.model}">
            </div>
            <div class="form-group has-danger">
                <label class="form-control-label" for="new-year">Year</label>
                <input class="form-control is-invalid ${invalid.year ? 'is-invalid' : ' is-valid'}" id="new-year" type="number" name="year" value="${furniture.year}">
            </div>
            <div class="form-group">
