...
namespace HAD.Core
{
    public class HeroManager : IManager
    {
        ...
        public string AddHero(IList<string> arguments)
        {
            ...
            string result = string.Format(Constants.HeroCreateMessage, hero.GetType().Name, heroName);
            return result;
        }
        ...
        public string AddRecipe(IList<string> arguments)
        {
            ...
            RecipeItem recipe = new RecipeItem(
                recipeName, strengthBonus, agilityBonus,
                intelligenceBonus, hitPointsBonus, damageBonus, requiredItems);

            heroes[heroName].AddRecipe(recipe);
